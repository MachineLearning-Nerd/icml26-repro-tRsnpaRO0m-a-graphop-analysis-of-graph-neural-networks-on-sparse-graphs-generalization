...
The [six canonical claim pages](../../pages/current/index.md) link the
contracts, raw JSON, primary code, independent checkers, controls, source
audit, and limitations. The experiment tree is cumulative: each child reruns
every earlier accepted check. The scientific winning branch is
