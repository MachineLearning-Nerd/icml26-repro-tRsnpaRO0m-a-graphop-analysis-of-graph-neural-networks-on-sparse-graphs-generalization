...
- [Raw certificate](../../evidence/claim_4/raw_results.json)
- [Primary verifier](../../code/graphop_repro/claims/claim4_didm_counterexample.py)
- [Independent checker](../../code/graphop_repro/independent/claim4_checker.py)
