...
- [Raw proof graph](../../evidence/claim_5/raw_results.json)
- [Primary verifier](../../code/graphop_repro/claims/claim5_universal_approximation.py)
- [Independent checker](../../code/graphop_repro/independent/claim5_checker.py)
- [Checker output](../../evidence/claim_5/checker_output.json)
- [Control output](../../evidence/claim_5/negative_control_output.json)
