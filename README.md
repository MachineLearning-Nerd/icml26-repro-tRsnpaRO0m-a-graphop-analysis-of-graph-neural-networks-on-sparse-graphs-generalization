...
| [`orx/evaluator-visible-general-proof-release`](https://github.com/MachineLearning-Nerd/icml26-repro-tRsnpaRO0m-a-graphop-analysis-of-graph-neural-networks-on-sparse-graphs-generalization/tree/orx/evaluator-visible-general-proof-release) | Package the exact 9/12 tree, proof certificates, manifests, and blind review | `uv run --frozen python -m graphop_repro.run_all` | formal release run passed; 748/748 hashes and cumulative checks pass | HF `cpu-upgrade`, one active core, about 22 s orchestrated |
