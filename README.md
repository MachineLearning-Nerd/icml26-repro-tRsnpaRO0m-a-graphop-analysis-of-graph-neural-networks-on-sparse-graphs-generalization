...
Current cumulative result: Claims 1 and 2 are exactly verified, while the
universally quantified strict-subset clause in Corollary 5.3 is falsified at
`L=0`. See the [candidate entrypoint](candidate/README.md).
